...
def save_earthquake(eq: dict) -> int:
    """Insert a new earthquake record and return its row id."""
    sql = """
...
def get_earthquakes(
    ...
    """Retrieve recent earthquakes with optional magnitude and time filters."""
    conditions = []
    params: list = []
...
def save_alert(alert: dict) -> int:
    """Insert a new alert record and return its row id."""
    sql = """
